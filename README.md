...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/cargo-zigbuild-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/cargo-zigbuild-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add cargo-zigbuild
# for installing globally
pixi global install cargo-zigbuild
```
...
It is possible to list all of the versions of `cargo-zigbuild` available on your platform:
...
```
pixi search cargo-zigbuild --channel conda-forge
```
